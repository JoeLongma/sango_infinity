...
namespace RTEditor
{
    public class SceneGizmo : MonoSingletonBase<SceneGizmo>
    {
        ...
        //void MyCameraRendering(ScriptableRenderContext context, Camera camera)
        {
            ...
            //Graphics.DrawMesh(MeshPool.Instance.BoxMesh, transformMatrices[(int)SceneGizmoComponent.Cube], material, 0, _gizmoCamera);
            ...
            for (int axisIndex = 1; axisIndex < axesCount; ++axisIndex)
            {
                ...
                //Graphics.DrawMesh(coneMesh, transformMatrices[axisIndex], material, 0, _gizmoCamera);
            ...
            if (fadingAxis0 != -1)
            {
                ...
                //Graphics.DrawMesh(coneMesh, transformMatrices[fadingAxis0], material, 0, _gizmoCamera);
            ...
            if (fadingAxis1 != -1)
            {
                ...
                //Graphics.DrawMesh(coneMesh, transformMatrices[fadingAxis1], material, 0, _gizmoCamera);
            ...
            for(int axisIndex = 0; axisIndex < 3; ++axisIndex)
            {
                ...
                //Graphics.DrawMesh(squareMesh, Matrix4x4.TRS(labelPos, axisLabelRotation, axisLabelScale), material, 0, _gizmoCamera);
