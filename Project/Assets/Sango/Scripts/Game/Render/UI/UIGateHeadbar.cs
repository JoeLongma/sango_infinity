...
namespace Sango.Game.Render.UI
{
    public class UIGateHeadbar : UICityHeadbar
    {
        public override void UpdateState(BuildingBase building)
        {
            ...
            string cityInfo = $"(人:{city.allPersons.Count} 闲:{city.freePersons.Count}) [商:{city.commerce},农:{city.agriculture},治:{city.security},建:{city.allIntriorBuildings.Count}/{city.InsideSlot}]\n<金:{city.gold}+{city.totalGainGold}>\n<粮:{city.food}+{city.totalGainFood}>";
